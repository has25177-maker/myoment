...
/* 음식 사전 텍스트 겹침 오류 해결 CSS (f-string 충돌 방지용 중괄호 2개 사용) */
.stTextInput > div:nth-child(2) > div:nth-child(2) {{
    display: none !important;
}}

/* 아이콘 숨김 CSS는 다른 오류를 방지하기 위해 제거했습니다. */
...
# ======================================
# 응급상황 AI – OpenStreetMap 기반 병원 검색
# ======================================
...
# 3) Streamlit 페이지
def page_osm_map():
    # st.title("📍 근처 동물병원 찾기 (OpenStreetMap)") # 제목이 중복되므로 주석 처리
...
def page_food_dict():
    ...
    with col1:
        # 겹침 오류 해결을 위해 label_visibility를 "collapsed"로 설정
